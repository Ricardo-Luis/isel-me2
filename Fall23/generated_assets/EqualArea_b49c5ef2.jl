...
using PlutoUI, PlutoTeachingTools, Plots, NumericalIntegration, Roots
#=
Brief description of the used Julia packages:
  ...
  - NumericalIntegration.jl, for numerically integrating presampled data
  - Roots.jl, simple routines for finding roots, or zeros
=#

# ╔═╡ dd81ad88-d8b7-41e6-ae46-85cf1b91d5d6
TwoColumnWideLeft(md"`EqualArea.jl`", md"`Last update: 03·12·2024`")
...
Sₙ, Uₙ,fₙ, p, Pᵤ, cosφ = 5e6, 6e3, 50, 2, 1e6, 1
...
# ╔═╡ 85aaa3f0-37a5-462c-b948-5a359924a7da
TableOfContents(title="Índice")

# ╔═╡ 9f4bac88-b25c-4611-a4b3-55e8092a62e6
md"""
!!! info "Informação"
	No índice deste *notebook*, o tópico assinalado com "💻" requer a participação do estudante.
"""

# ╔═╡ d1ebe3ba-959f-46dd-9d31-033aa348c8ae
md"""
|  |  |
|:--:|:--|
|  | This notebook, [EqualArea.jl](https://ricardo-luis.github.io/isel-me2/Fall23/data_science/EqualArea/), is part of the collection "[_Notebooks_ Reativos de Apoio a Máquinas Elétricas II](https://ricardo-luis.github.io/isel-me2/)" by Ricardo Luís. |
...
manifest_format = "2.0"
project_hash = "c1cb565f98c24cb664d7cc0de6867be19250b854"
