...
# ╔═╡ e8bb7553-27c0-48db-8f9f-a0f6c0e3c8c3
ThreeColumn(md"`Vcurves.jl`", md"[![](https://img.shields.io/badge/GitHub_URL-notebook-C09107)](https://github.com/Ricardo-Luis/notebooks/blob/main/ME2/Vcurves.jl)", md"`Last update: 11·09·2023`")

# ╔═╡ 1c9d2490-8aec-4baa-908c-6efddb04d31f
begin
	html"""
	<style>
		main {
...
# ╔═╡ 9576ee18-0f8e-45e6-b597-cd64bc02a0fc
md"""
---
...
$\textbf{curvas "V" (curvas de Mordey)}$
---
"""

# ╔═╡ 2eff7a5a-55b9-4c0e-912b-ea2bb0f3e497
md"""
# Dados:
"""
...
**Traçar as retas de potência ativa e reativa correspondentes a:**
...
Desta forma, a posição dos afixos dos vetores, $$jX_s\overline I$$ ou $$\overline{E}_0$$, representam, adequando a escala para potências, o ponto de funcionamento da máquina, $$(Q, P)$$, num sistemas de eixos de potência ativa e reativa, representados a partir do afixo do vetor da tensão, $$\overline U$$:
"""

# ╔═╡ df708c4d-443b-4190-b72d-779c4e1e1bb1
md"""
 $$P\: (\rm W):$$ $(@bind P PlutoUI.Slider(0:5.0e3:20e3, default=15000,show_value=true)) $$\quad$$ $$\quad; \quad Q\:(\rm VAr):$$ $(@bind Q PlutoUI.Slider(-20e3:5.0e3:20e3, default=10000, show_value=true))

Linhas de $$Q$$ constante: $(@bind z2 CheckBox()) $$\quad$$;$$\quad$$ Linhas de $$P$$ constante: $(@bind z1 CheckBox())
"""
...
**Traçar as curvas em V das potências requeridas.**
"""

# ╔═╡ db0fc7c2-9e8c-415f-95c1-686dbfc56347
md"""
O traçado das curvas em "V", ou curvas de Mordey, corresponde a uma representação do mapa de funcionamento da máquina síncrona, traduzido num conjunto de isolinhas para a potência ativa, que relacionam diferentes pares de valores $$(I_{exc}, I)$$ ou $$(E_0, I)$$ representando diferentes fatores de potência.
...
md"""
Assinale-se também para $$Q=0\mathrm {VAr}$$, $$(I\sin\varphi=0)$$, que a corrente do estator terá o valor mais baixo em cada isolinha de potência ativa. Esses pontos de funcionamento são designados por **pontos de excitação ótima**.
"""

# ╔═╡ 1b4d9fbd-be46-416a-a1fe-163f5a0b37a3
md"""
!!! nota
	O estudante deverá procurar perceber onde se encontram os modos sobreexcitado e subexcitado, nos regimes de funcionamento alternador e motor, bem como os casos particulares da máquina a funcionar como compensador síncrono.
"""
...
# ╔═╡ 62c8faef-d834-4a7a-9b3d-7e2894f1de2b
...
# ╔═╡ ad142a40-0441-4a56-9bcd-b323e3c25b16
begin
	# other stuff:
...
# ╔═╡ aa40df66-b744-4d6e-aa69-3fa958c691c7
...
# ╔═╡ cbeb0218-c991-42fc-a8f0-beab9596654f
md"""
*Notebook* realizado em linguagem de computação científica `Julia` versão $(version).

**_Time to first plot_**: até cerca de 1.4 min.

**Computador**: Intel® Core™ i5-7600U CPU @ 2.80GHz; 24GB RAM.
"""

# ╔═╡ 27b750d7-5eef-4561-ac27-3391207c2dbb
md"""
!!! info
...
# ╔═╡ 71585074-59d5-4bee-bc32-adf9d0c3ae72
md"""
---
"""

# ╔═╡ dbc00b8e-0738-44c8-94c7-88ec590c0095
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "8de4cb7132556721bd608f7479cb14a6182b5015"
